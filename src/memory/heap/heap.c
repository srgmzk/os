...
static int
heap_validate_table(void *start, void *end, struct heap_table *table)
{
	int res = 0;
...
int
heap_create(struct heap *heap, void *start, void *end, struct heap_table *table)
{
	int res = 0;
...
void *
heap_block_to_address(struct heap *heap, int block)
{
